              ...
              <b-container>
                <b-row>
                  <b-col cols="12">
                      ...
                      >
                        <template slot-scope="props" slot="actions"  v-if="utilisateurCourant.profilId!=4 && (((utilisateurCourant.profilId==2 && props.data.structureId == utilisateurCourant.structureId)  || (utilisateurCourant.profilId==3 && props.data.ustid == utilisateurCourant.ustid) )  ) ">
