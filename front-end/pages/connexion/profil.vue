    ...
    <b-container class="interventions">
      <b-row>
        <b-col cols="6" offset="3" >
            ...
            <mon-compte :user="user" :check-legal="false" :cancel-txt="'Annuler'" :submit-txt="'Enregistrer'" @submit="editProfile" @cancel="cancelEdit"/>
        </b-col>
      </b-row>
    </b-container>
  </section>
  ...
  methods: {
    ...
    async editProfile(){
        ...
        .then(async response => {
            ...
            console.log(response.user.mailcontact)
